...
export const criarReservaTool: MCPToolDefinition = {
...
export const listarReservasTool: MCPToolDefinition = {
...
export const informarVendaTool: MCPToolDefinition = {
...
export async function handleCriarReserva(args: unknown): Promise<string> {
...
export async function handleListarReservas(args: unknown): Promise<string> {
  const client = getCVCRMClient();
...
export async function handleInformarVenda(args: unknown): Promise<string> {
  const client = getCVCRMClient();
