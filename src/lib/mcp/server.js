...
// Importar tools
import { criarAtendimentoTool, listarAtendimentosTool, handleCriarAtendimento, handleListarAtendimentos, cadastrarClienteTool, buscarClientesTool, handleCadastrarCliente, handleBuscarClientes, criarReservaTool, listarReservasTool, informarVendaTool, handleCriarReserva, handleListarReservas, handleInformarVenda, } from './tools';
// Importar tools Luna Nova
import { identificarClienteTool, handleIdentificarCliente, consultarParcelasTool, gerarBoletoTool, handleConsultarParcelas, handleGerarBoleto, criarChamadoTool, consultarChamadosTool, handleCriarChamado, handleConsultarChamados, listarEmpreendimentosTool, handleListarEmpreendimentos, } from './tools/luna';
export class CVCRMMCPServer {
    server;
    client = getCVCRMClient();
